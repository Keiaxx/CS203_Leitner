 ...
 *
 */
public class Leitner implements Serializable{
     ...
     * @precondition s != null
     */
    public boolean testAnswer(Challenge s) {

        String in = (String) s.getChallenge();
        
        return in.equalsIgnoreCase((String) pickedCard.getPrompt().toString()) || in.equalsIgnoreCase((String) pickedCard.getResponse().toString());
    }
